...
func resourceArmCosmosDBAccountRead(d *schema.ResourceData, meta interface{}) error {
	...
	// ListKeys returns a data structure container a DatabaseAccountListReadOnlyKeysResult pointer
	// implying that it also returns the read only keys, however this appears to always be nil
